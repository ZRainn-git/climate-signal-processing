...
**[View the analysis notebook](notebook/environmental-time-series-filtering.ipynb)**  
**[Read the full project report](report/environmental-time-series-filtering.pdf)**
